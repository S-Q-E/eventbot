...
async def admin_help_message(callback: types.CallbackQuery):
    ...
    await callback.message.answer("<b> Справка </b>\n"
                                  ...
                                  "🔹 <code>Незарег. пользователи</code> - список всех пользователей когда-либо запускавших бота\n"
                                  "🔹 <code>Сгенерировать отчет</code> - генерация Excel файла с данными о пользователях\n", reply_markup=markup)