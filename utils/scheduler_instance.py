...
def check_events(bot, scheduler, db_session):
    """
    ...
    with db_session as db:
        ...
        for event in events:
            ...
            scheduler.add_job(
                ...
                trigger="date",
                run_date=event.event_time + timedelta(minutes=1),
...
def start_scheduler(bot):
    ...
    scheduler.add_job(check_events, "interval", seconds=60, args=[bot, scheduler, next(get_db())])  # Интервал: 1 минута
    scheduler.start()
